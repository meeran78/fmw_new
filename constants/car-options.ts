...
export const CAR_MODEL_OPTIONS = [
  ...
  { key: "bmw", value: "bmw-x5", label: "BMW X5" },
  { key: "bmw", value: "bmw-x6", label: "BMW X6" },
  { key: "bmw", value: "bmw-x7", label: "BMW X7" },
  { key: "bmw", value: "bmw-x3", label: "BMW X3" },
  { key: "bmw", value: "bmw-x4", label: "BMW X4" },
  { key: "bmw", value: "bmw-x2", label: "BMW X2" },
  { key: "bmw", value: "bmw-x1", label: "BMW X1" },
  { key: "bmw", value: "bmw-i8", label: "BMW i8" },
];
